...
export const predictions: Prediction[] = [
  ...
  // ============================================
  {
    ...
    proxies: [
      {
        id: 'iran-conflict-ends',
        name: 'Iran x Israel/US conflict ends by June 30?',
        type: 'polymarket',
        polymarketSlug: 'iran-x-israelus-conflict-ends-by-june-30',
        polymarketTitle: 'Iran x Israel/US conflict ends by June 30?',
        polymarketUrl: 'https://polymarket.com/event/iran-x-israelus-conflict-ends-by',
        baseline: { value: 75, date: '2026-03-11', label: '75%' },
        description: 'Higher = conflict resolved (less Arab instability)',
      },
    ],
  },
  {
